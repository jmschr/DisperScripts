...
class MicroscopeWindow(BaseView, QMainWindow):
    def __init__(self, experiment):
        ...
        self.power_slider_633.valueChanged.connect(self.update_laser_633)
        self.power_slider_488.valueChanged.connect(self.update_laser_488)
    ...
    def update_ui(self):
        ...
        self.power_slider_633.setValue(self.experiment.config['laser_633']['power'])
        self.lcd_laser_power_488.display(self.experiment.config['laser_633']['power'])
        self.power_slider_488.setValue(self.experiment.config['laser_488']['power'])
        self.lcd_laser_power_488.display(self.experiment.config['laser_488']['power'])
    ...
    def update_laser_633(self, power):
        power = int(power)
        self.lcd_laser_power_633.display(power)
        self.experiment.set_laser_power_633(power)

    def update_laser_488(self, power):
        power = int(power)
        self.lcd_laser_power_488.display(power)
        self.experiment.set_laser_power_488(power)
